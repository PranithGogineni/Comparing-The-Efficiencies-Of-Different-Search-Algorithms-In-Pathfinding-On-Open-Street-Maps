...
# Step 1: Load a Road Network Focused on Cambridge, UK
place_name = "Cambridge, England, UK"
...
# Step 2: Select Start and Goal Nodes (University of Cambridge -> Cambridge Railway Station)
start_lat, start_lon = 52.2053, 0.1218  # University of Cambridge (Senate House)
goal_lat, goal_lon = 52.1944, 0.1386    # Cambridge Railway Station
...
def the_heuristic(u, v):
    ...
    return 0.1 * ((x2 - x1)**2 + (y2 - y1)**2)**0.5  # Weakened Euclidean
...
# Step 5: BFS Search (Manual implementation)
